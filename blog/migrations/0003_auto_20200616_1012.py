# Generated by Django 3.0.6 on 2020-06-16 08:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('blog', '0002_auto_20200528_1237'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='bloglistingpage',
            options={'verbose_name': 'Blogliste', 'verbose_name_plural': 'Bloglisten'},
        ),
        migrations.AlterModelOptions(
            name='blogpage',
        ...
        migrations.AlterField(
            model_name='blogpage',
            name='blogImage',
            field=models.ForeignKey(blank=True, help_text='this image will also be displayed in the listing page and over there gets cropped to ~300x200 ', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.Image'),
        ),
        migrations.AlterField(
            model_name='blogpage',
            name='body',
